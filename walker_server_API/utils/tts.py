...
class TextToSpeechService:
    def __init__(self, device: str = "cuda" if torch.cuda.is_available() else "cpu"):
        ...
        """
        self.device = device
        self.processor = AutoProcessor.from_pretrained("suno/bark-small", torch_dtype=torch.float16)
        self.model = BarkModel.from_pretrained("suno/bark-small",torch_dtype=torch.float16)
        self.model.to(self.device)


    def synthesize(self, text: str, voice_preset: str = "v2/es_speaker_7"):
        """
    ...
    def long_form_synthesize(self, text: str, language_code: str = "en"):
        """
        ...
        voice_preset = language_to_preset.get(language_code, "v2/en_speaker_6")  
